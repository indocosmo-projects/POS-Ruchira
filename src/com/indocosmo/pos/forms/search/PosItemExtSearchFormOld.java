...
public class PosItemExtSearchFormOld extends JDialog {
	...
	public PosItemExtSearchFormOld(
	...
	public PosItemExtSearchFormOld(String[] colNames, String[] fieldList,
			ArrayList<? extends IPosSearchableItem> searchList) {
	...
	protected void createResultTable() {
		...
		tableSelModel.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				if (mListner != null) {
					if(mListner.onAccepted(PosItemExtSearchFormOld.this,mSelectedItem))
						dispose();
				}else
					dispose();
			}
	...
	private IPosSoftKeypadListner softKeypadListener=new IPosSoftKeypadListner() {
		...
		public void onCancel() {
			//			setVisible(false);
			if (mListner != null){
				if(mListner.onCancel(PosItemExtSearchFormOld.this))
					dispose();
			}else
				dispose();
		}
