...
public class PosExtSearchForm extends JDialog {
	...
	protected static   int SEARCH_RESULT_PANEL_WIDTH = PosSoftKeyPadSingleLineInput.LAYOUT_WIDTH;
	private static final int SEARCH_RESULT_PANEL_HEIGHT = 260;
	...
	public static   int LAYOUT_WIDTH = SEARCH_RESULT_PANEL_WIDTH
	...
	public PosExtSearchForm(String[] colNames, String[] fieldList,
			ArrayList<? extends IPosSearchableItem> searchList) {
...
//	/**
//	 * @param oRDER_RETRIEVE_SEARCH_COLUMN_NAMES
//	 * @param oRDER_RETRIEVE_SEARCH_FIELD_LIST
//	 * @param searchList
//	 * @param b
//	 */
//	public PosExtSearchForm(String[] oRDER_RETRIEVE_SEARCH_COLUMN_NAMES,
//			String[] oRDER_RETRIEVE_SEARCH_FIELD_LIST,
//			ArrayList<? extends IPosSearchableItem> searchList, boolean enableHorizontalScroll) {
//		
...
//	}
	...
	private void initWindow(IPosSearchableItem[] searchList) {
		...
		mSoftKeyPad.setSize(SEARCH_RESULT_PANEL_WIDTH, PosSoftKeyPadSingleLineInput.LAYOUT_HEIGHT);
		add(mSoftKeyPad);
	...
	protected JTable getSearchTable() {
		...
		searchTable.getTableHeader().setResizingAllowed(true);
	...
	protected void createResultTable() {
		...
		tableSelModel.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				if (mListner != null) {
					if(mListner.onAccepted(PosExtSearchForm.this,mSelectedItem))
						dispose();
				}else
					dispose();
			}
	...
	private IPosSoftKeypadListner softKeypadListener=new IPosSoftKeypadListner() {
		...
		public void onCancel() {
			//			setVisible(false);
			if (mListner != null){
				if(mListner.onCancel(PosExtSearchForm.this))
					dispose();
			}else
				dispose();
		}
...
//		mSoftKeyPad.setListner(softKeypadListener);
	...
	/**
	 * @return the enableHorizontalScroll
	 */
	...
	/**
	 * @param enableHorizontalScroll the enableHorizontalScroll to set
	 */
	public void setEnableHorizontalScroll(boolean enableHorizontalScroll) {
		
		this.enableHorizontalScroll = enableHorizontalScroll;
		if(mSearchResultTable!=null)
			mSearchResultTable.setAutoResizeMode((this.enableHorizontalScroll)?JTable.AUTO_RESIZE_OFF:JTable.AUTO_RESIZE_LAST_COLUMN);
	}
