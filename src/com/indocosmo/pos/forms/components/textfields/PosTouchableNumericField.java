...
public class PosTouchableNumericField extends PosTouchableFieldBase {

	private PosNumKeypadForm mNumKeyPadForm;
	protected Object mMaxValue=null;
	protected Object mMinValue=null;
	
	public PosTouchableNumericField(RootPaneContainer parent, int width, int height) {
		super(parent, width, height);
		// TODO Auto-generated constructor stub
	}

	public PosTouchableNumericField(RootPaneContainer parent, int width) {
		super(parent, width);
		// TODO Auto-generated constructor stub
	}

	public PosTouchableNumericField(RootPaneContainer parent) {
		super(parent);
		// TODO Auto-generated constructor stub
	}
	...
	protected void setDocType() {
		mTextFiled.setDocument(PosNumberUtil.createDecimalDocument(true));
	}
