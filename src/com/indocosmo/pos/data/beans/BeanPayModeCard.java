...
public final class BeanPayModeCard extends BeanPayModeBase {	
	...
	private BeanPaymentCard mCardItems;

	public BeanPayModeCard() {
		super();
	...
	/**
	 * @return the mCardItems
	 */
	public final BeanPaymentCard getCardItems() {
		return mCardItems;
	}


	/**
	 * @param mCardItems the mCardItems to set
	 */
	public final void setCardItems(BeanPaymentCard cardItems) {
