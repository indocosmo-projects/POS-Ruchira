 ...
 *
 */
public final class EFTResponseMessageMAN extends EFTMessageBase {
	
	private String mCardAmount;
	private EFTPurchaseStatus mStatus;
	private String mDisplayMessage;
	private String mBankReferance;
	 ...
	 */
	public String getBankReferance() {
		return mBankReferance;
	}
	/**
	 * @param bankReferance the bankReferance to set
	 */
	public void setBankReferance(String bankReferance) {
		mBankReferance = bankReferance;
	}
	/**
